...
import { FileText, User, Mail, Phone, Calendar, CreditCard, AlertCircle, CheckCircle2, XCircle, Clock } from 'lucide-react';
...
export const Route = createFileRoute('/kabale/applications')({
  loader: async () => {
              ...
              <Empty>
                ...
                <EmptyHeader>
                  ...
                  <EmptyDescription className="text-base">
                    No ID applications have been submitted to your Kabale yet.
                  </EmptyDescription>
                </EmptyHeader>
              </Empty>
            </Card>
