    ...
    <div className="flex min-h-screen items-center justify-center p-4">
      <Card className="w-full max-w-2xl">
        <CardHeader>
          ...
          <CardDescription>Please provide your personal information and select your Kabale</CardDescription>
        </CardHeader>
        <CardContent>
          <Form {...form}>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <Select onValueChange={field.onChange} defaultValue={field.value} disabled={loadingKabales}>
                      <FormControl>
                        <SelectTrigger>
                          <SelectValue placeholder={loadingKabales ? 'Loading Kabales...' : 'Select a Kabale'} />
                        </SelectTrigger>
                      </FormControl>
                      <SelectContent>
                        {kabales.map((kabale) => (
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Textarea placeholder="Enter your address" {...field} value={field.value || ''} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
